...
export const zhCNDict = {
  ...
  research: {
    title: "研究",
    remaining: "本周剩余 {n} 次 · {weekday} 重置",
    remainingNoReset: "本周剩余 {n} 次",
    questionLabel: "问题",
    questionPlaceholder: "想研究什么？",
    focusToggle: "重点关注 / 排除",
    focusPlaceholder: "需要强调或跳过的内容…",
    start: "开始研究",
    starting: "正在发起…",
    empty: "还没有研究。在上方提出问题即可开始。",
    statusQueued: "排队中",
    statusRunning: "进行中",
    statusDone: "已完成",
    statusCancelled: "已取消",
    ...
    phasePlan: "规划",
    phaseGather: "收集来源",
    phaseSynthesize: "撰写报告",
    sourcesFound: "已找到 {n} 个来源",
    cancel: "取消",
    confirmCancel: "确认取消",
    keepGoing: "继续",
    cancelled: "本次研究已取消。",
    failedSystem: "系统繁忙，本次不计次，请重试。",
    report: "报告",
    references: "参考文献",
    backToList: "返回列表",
    waiting: "等待开始…",
    ...
    subSkipped: "已跳过",
    subSources: "{n} 来源",
    synthesizeHint: "按方向归纳、逐条标注引用",
    recentSources: "刚刚读到",
    sourcesUnit: "来源",
    processDone: "研究过程 · {n} 个方向全部完成",
    ...
    paywall: {
      ...
      cap1Title: "自己决定搜什么",
      cap1Desc: "拆成几个子问题分头检索，看完再补搜遗漏的方向。",
      cap2Title: "每句结论都能点回原文",
      cap2Desc: "正文逐句标注编号，文末列出全部来源链接。",
      cap3Title: "跑在云端，关掉侧栏也继续",
      cap3Desc: "一次十来分钟，写完通知你。不占用你的浏览器。",
      subscribe: "登录并了解订阅",
      quotaNote: "每周 3 次深度研究 · 含全部模型",
      samples: "深度研究案例",
      sampleMeta: "{sources} 来源 · {searches} 次搜索 · {minutes} 分钟",
    },
    error: {
      quotaExceeded: "本周研究次数已用完，{date} 重置。",
      quotaExceededNoDate: "本周研究次数已用完。",
      inProgress: "已有研究正在进行。请等待完成或取消后再发起。",
      unavailable: "研究服务暂时不可用，请稍后再试。",
      requiresPro: "深度研究是 Pro 功能。",
      generic: "无法发起研究，请重试。",
      loadFailed: "无法加载研究，请重试。",
    },
  },
  managed: {
    models: {
