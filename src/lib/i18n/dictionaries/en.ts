...
export const enDict = {
  ...
  research: {
    ...
    planDone: "Broke it into {n} directions",
    subSearching: "searching",
    subSkipped: "skipped",
    subSources: "{n} sources",
    synthesizeHint: "Group by direction, cite every claim",
    recentSources: "Just read",
    sourcesUnit: "sources",
    processDone: "Research process · all {n} directions done",
    ...
    paywall: {
      ...
      cap1Desc: "Splits your question into sub-questions, then fills whatever gaps it finds.",
      cap2Title: "Every claim links back",
      cap2Desc: "Numbered citations inline, the full source list at the end.",
      cap3Title: "Runs in the cloud",
      cap3Desc: "Takes about ten minutes. Close the panel — it notifies you when it's done.",
      subscribe: "Sign in to see plans",
      quotaNote: "3 deep research runs a week · all models included",
      samples: "Deep research samples",
      sampleMeta: "{sources} sources · {searches} searches · {minutes} min",
    },
    error: {
