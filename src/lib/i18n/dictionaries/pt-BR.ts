...
export const ptBRDict = {
  ...
  customProvider: {
    ...
    wireHint: "Escolha Responses para proxies que expõem gpt-5.x; caso contrário, mantenha Chat Completions",
    testing: "Testando...",
  ...
  research: {
    ...
    planDone: "Dividido em {n} frentes de pesquisa",
    subSearching: "buscando",
    subSkipped: "ignorada",
    subSources: "{n} fontes",
    synthesizeHint: "Agrupar por frente e citar cada afirmação",
    recentSources: "Lido agora",
    sourcesUnit: "fontes",
    processDone: "Processo · {n} frentes concluídas",
    ...
    paywall: {
      ...
      cap1Desc: "Divide sua pergunta em subperguntas e depois cobre as lacunas que encontra.",
      cap2Title: "Toda afirmação tem origem",
      cap2Desc: "Citações numeradas no texto e a lista completa de fontes no fim.",
      cap3Title: "Roda na nuvem",
      cap3Desc: "Leva uns dez minutos. Feche o painel — ele avisa quando terminar.",
      subscribe: "Entre e veja os planos",
      quotaNote: "3 pesquisas profundas por semana · todos os modelos incluídos",
      samples: "Exemplos de pesquisa profunda",
      sampleMeta: "{sources} fontes · {searches} buscas · {minutes} min",
    },
    error: {
