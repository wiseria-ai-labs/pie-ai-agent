...
export const ptBRDict = {
  ...
  handoff: {
    ...
    form: {
      ...
      noteAppWeb: "A interface web abre com esta pasta registrada como workspace. O brief está na área de transferência — se a UI ainda estiver em outro workspace, escolha este, cole e envie.",
    },
  },
  skillRunConfirm: {
