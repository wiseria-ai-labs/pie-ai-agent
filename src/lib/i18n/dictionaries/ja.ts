...
export const jaDict = {
  ...
  skillRunConfirm: {
    ...
    disclosureNone:
      "このスクリプトは追加のサンドボックスなしで、あなたのユーザーアカウントとして実行されます。アカウントが読み書きできるものにはアクセスできます。承認すると、このスキルはこのセッションの間スクリプトを実行できます。",
    allow: "許可して実行",
    deny: "拒否",
  },
  chat: {
  ...
  research: {
    ...
    planDone: "{n} 個の調査方向に分解",
    subSearching: "検索中",
    subSkipped: "スキップ",
    subSources: "{n} 件",
    synthesizeHint: "方向ごとにまとめ、各主張に出典を付与",
    recentSources: "直近に読んだ情報",
    sourcesUnit: "件",
    processDone: "調査プロセス · {n} 方向すべて完了",
    ...
    paywall: {
      ...
      cap1Desc: "サブ質問に分けて並行検索し、足りない方向は後から補います。",
      cap2Title: "すべての記述に出典",
      cap2Desc: "本文に番号付きの引用、末尾に全出典リスト。",
      cap3Title: "クラウドで実行、閉じても継続",
      cap3Desc: "所要は十数分。パネルを閉じても走り続け、完了時に通知します。",
      subscribe: "ログインしてプランを見る",
      quotaNote: "週 3 回のディープリサーチ · 全モデル込み",
      samples: "ディープリサーチの実例",
      sampleMeta: "{sources} 件の情報源 · {searches} 回の検索 · {minutes} 分",
    },
    error: {
